...
const MODE_CTB = 3;
const MIN_SENSOR = 1;
const MAX_SENSOR = 500;
const MIN_SWITCH = 500;
const MAX_SWITCH = 1000;
const MIN_OTHER = 1001;
...
const GUIDE = [{ "icon": "icon-light", "name": "灯具类", "desc": "吸顶灯，筒灯，吊灯",  "step": [{ "icon": "icon-plug", "step": "第一步", "info": "确保设备上电" }, { "icon": "icon-setting", "step": "第二步", "info": "确保已对设备进行正确设置，并连接互联网，联网正常时设备指示灯常亮" }, { "icon": "icon-setting", "step": "第三步", "info": '点击"继续添加"添加设备' }], "problem": ["1. 给设备上电时，同时按下复位按钮；", "2. 开机等待3秒左右，指示灯快速闪烁，放开复位按钮；", "3. 重新设置设备信息"]  },
  { "icon": "icon-sensor", "name": "传感器类", "desc": "人体传感器，温湿度传感器"}];
